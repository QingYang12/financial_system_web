<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <span><b>收入金额:</b></span><el-input v-model="listQuery.money" placeholder="收入金额" style="width: 140px;margin-right:50px;" class="filter-item"  clearable />
      <span><b>发生时间:</b></span>
      <el-date-picker
    ...
    >
      ...
      <el-table-column label="收入类别" prop="type" sortable="custom" align="center"  :class-name="getSortClass('id')">
        <template slot-scope="{row}">
          <span>{{ row.type }}</span>
        </template>
      </el-table-column>
      <el-table-column label="收入金额" prop="money" sortable="custom" align="center"  :class-name="getSortClass('id')">
        <template slot-scope="{row}">
          <span>{{ row.money }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="80px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="收入类别" prop="type" >
...
<script>
import { fetchincomeList, fetchUser,deleteincome, createincome, updateincome } from '@/api/financial'
...
export default {
  ...
  methods: {
    getList() {
      ...
      fetchincomeList(params).then(response => {
